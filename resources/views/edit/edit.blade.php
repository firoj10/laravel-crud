...
@csrf
  <div class="form-row row">
    <div class="form-group col-md-6">
      ...
      <input type="text" name="name" value="{{$student->name}}" class="form-control" id="inputEmail4" placeholder=" enter your name">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
      ...
      <input type="email" value="{{$student->email}}" name="email" class="form-control" id="inputEmail4" placeholder=" enter your email">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-group">
    ...
    <input type="text" value="{{$student->address}}" name="address" class="form-control" id="inputAddress" placeholder="1234 Main St">
  </div>
